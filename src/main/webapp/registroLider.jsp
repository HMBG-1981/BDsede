<%-- 
    Document   : registroLider
    Created on : 25/08/2025, 8:37:23 a. m.
    Author     : jedab
--%>
...
<body>
    <h2>Registro de Líderes</h2>

    <!-- FORMULARIO DE REGISTRO -->
    <form action="registroLiderServlet" method="post" onsubmit="return validarContrasena();">
        <div class="form-row">
    ...
    <form action="CargarLiderServlet" method="post" enctype="multipart/form-data">
