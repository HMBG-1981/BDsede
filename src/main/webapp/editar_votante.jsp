...
<body>
    ...
    <form method="get" action="editar_votante.jsp">
        ...
        <input type="text" id="cedula" name="cedula" value="<%= request.getParameter("cedula") != null ? request.getParameter("cedula") : "" %>" required>
    ...
    <%
        ...
        if (cedula != null && !cedula.isEmpty() && (mensaje == null || mensaje.isEmpty())) {
            try {
                ...
                out.println("<p class='mensaje'>Error: " + e.getMessage() + "</p>");
            } finally {
